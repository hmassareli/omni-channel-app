...
export function ContactTimeline({ userName }: ContactTimelineProps) {
  ...
  const messages = [
    ...
    },
    {
      ...
      time: "10:32",
      message:
        "Olá! Claro, posso te ajudar. O produto X tem as seguintes características...",
      isInbound: false,
    },
    {
      sender: "Cliente",
    ...
    },
    {
      ...
      time: "10:40",
      message:
        "O investimento é de R$ 2.500,00 com condições especiais para pagamento à vista.",
      isInbound: false,
    },
    {
      sender: "Cliente",
      time: "10:42",
      message: "Interessante! Vou pensar e retorno em breve.",
      isInbound: true,
    },
  ];
  ...
  return (
    <div className="flex-1 flex flex-col">
      {/* Header do Contato + Pipeline */}
      <div className="bg-white shadow-sm">
        <ContactHeader contactName="Maria Oliveira" phone="+55 11 99999-0001" />
      ...
      <main className="flex-1 w-full px-6 py-6 grid grid-cols-12 gap-6 overflow-auto">
        ...
        <aside className="col-span-3 bg-white rounded-lg border border-gray-200 p-4 h-fit shadow-sm">
          ...
          <SidebarSection title="Informações">
            <InfoRow label="Responsável" value={userName || "Não atribuído"} />
